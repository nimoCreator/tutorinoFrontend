<template>
    <div class="offer">
        <div class="top">
            ...
            <span class="price">{{offer.pricePerHour}} {{offer.currency}} /h</span>
                ...
                <div class="title">
                    <span class="name">
                        {{offer.name}}
                        <span class="handle">{{offer.handle}}</span>
                    </span>
        ...
        <div class="bottom">
            <span class="rating">
                <span class="stars">{{ offer.rating }}</span> 
                <span class="amount">({{ offer.ratingAmount }})</span>
                ⭐
            </span>
...
export default {
    ...
    computed: {
        imageUrl() {
            return `${pfpPath}${this.offer.image}`;
        },
    },
    methods: {
        toggleFav() {
...
.offer .details .descriptio::after {
    transition: 1s;
}
.offer:hover .details .descriptio::after {
    top: calc( 100% + 8rem );
